...
import tatait.com.noteex.util.ZoomImageView;
...
public class ImageDetailsActivity extends Activity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// 设定当前的页数和总页数
		pageText.setText((imagePosition + 1) + "/" + Images.imageUrl.length);
	}
	...
	class ViewPagerAdapter extends PagerAdapter {
		...
		public Object instantiateItem(ViewGroup container, int position) {
			String imagePath = getImagePath(Images.imageUrl[position]);
	...
	public void onPageSelected(int currentPage) {
		...
		pageText.setText((currentPage + 1) + "/" + Images.imageUrl.length);
	}
