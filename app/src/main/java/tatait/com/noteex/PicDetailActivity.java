...
public class PicDetailActivity extends BaseActivity {
    ...
    protected void initView(Bundle savedInstanceState) {
        ...
        if (!isVip) {
            ...
            //
            showAsPopup();
            pic_layout_right.setVisibility(View.VISIBLE);
        }else{
            pic_layout_right.setVisibility(View.GONE);
        }
    }
        ...
        switch (arg0.getId()) {
            ...
            case R.id.pic_layout_right:
                if (!(Boolean) SharedPreferencesUtils.getParam(mApp, CommonUtil.ISLOGIN, false)) {
                    ...
                    AlertDialog dialog = new AlertDialog(PicDetailActivity.this);
                    dialog.builder().setTitle("1元开通VIP即可关闭广告,永久保持哦").setMsg("请截图或者使用支付宝扫描二维码进行付款，付款后将您的专属ID发送到客服QQ（2443938389）激活").setMsgId(vipId).setNegativeButton("获取二维码", new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                            ImageViewDialog dialog = new ImageViewDialog(PicDetailActivity.this);
