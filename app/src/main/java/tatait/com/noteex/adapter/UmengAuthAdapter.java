...
public class UmengAuthAdapter extends BaseAdapter {
    private ArrayList<SnsPlatform> list;
    private Context mContext;
    private Activity mActivity;
    private ProgressDialog dialog;

    public UmengAuthAdapter(Context context, ArrayList<SnsPlatform> list) {
        this.list = list;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = LayoutInflater.from(mContext).inflate(R.layout.umeng_authadapter, null);
        }
