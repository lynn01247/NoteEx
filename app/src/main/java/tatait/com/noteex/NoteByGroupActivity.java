...
import tatait.com.noteex.fragment.MainByGroupFragment;
import tatait.com.noteex.slide.SwipeBackHelper;

public class NoteByGroupActivity extends BaseActivity {
    ViewPager viewPager;
    LinearLayout back;
    ...
    protected void processLogic(Bundle savedInstanceState) {
        ...
        Fragment recyclerFragment = new MainByGroupFragment();
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.title_layout_op_iv: // refresh
                ((MainByGroupFragment) fragmentList.get(0)).refreshGetData(true);
                break;
            case R.id.title_layout_op_iv2:// more
                ((MainByGroupFragment) fragmentList.get(0)).MenuMoreClick();
                break;
        }
    }
